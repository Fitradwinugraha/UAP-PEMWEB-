...
<head>
    ...
    <title>Meow Hotel - Karyawan</title>
...
<body>
    ...
    <div class="main-content">
        <header>
            <div class="menu-toggle">Karyawan</div>
        </header>
        <div class="content">
            <div class="top-bar">
                ...
                <button class="add-data" onclick="location.href='tambahkaryawan.php'">+ Tambah Data</button>
            </div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    // Query SQL untuk mengambil data karyawan dari database berdasarkan kata kunci pencarian
                    if (isset($_GET['keyword']) && !empty($_GET['keyword'])) {
                        $keyword = mysqli_real_escape_string($mysqli, $_GET['keyword']);
                        $query = "SELECT * FROM karyawan WHERE namakaryawan LIKE '%$keyword%' OR jeniskelamin LIKE '%$keyword%' OR posisi LIKE '%$keyword%' OR notelepon LIKE '%$keyword%'";
                    } else {
                        // Query SQL untuk mengambil semua data karyawan jika tidak ada kata kunci pencarian
                    ...
                    // Perulangan untuk menampilkan data karyawan dalam tabel
                    $no = 1;
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<button class='edit' onclick='editData(" . $row['id_karyawan'] . ")'><i class='fas fa-edit'></i></button>";
                        echo "<button class='delete' onclick='deleteData(" . $row['id_karyawan'] . ")'><i class='fas fa-trash-alt'></i></button>";
                        echo "</td>";
                        echo "</tr>";
                    }
                    ?>
    ...
    <script>
        function deleteData(id) {
            if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
                window.location.href = "hapuskaryawan.php?id=" + id;
            }
        }
